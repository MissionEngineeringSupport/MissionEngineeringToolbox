...
public class RadarWaveformSettings
{
    ...
    public double MaximumUnambiguousRange_m => RadarFunctions.CalculateRangeTwoWay(PulseRepetitionInterval_s);
    ...
    public double PulseWidthUncompressed_m => RadarFunctions.CalculateRangeTwoWay(PulseWidth_s);
